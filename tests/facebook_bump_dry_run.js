...
test('Worker uses one persistent browser and can focus an existing window',()=>{
  ...
  assert(index.includes('app.js?v=20260911-v20.2-admin-performance-6')&&serviceWorker.includes('app.js?v=20260911-v20.2-admin-performance-6'),'PWA cache does not include the combined admin performance build');
