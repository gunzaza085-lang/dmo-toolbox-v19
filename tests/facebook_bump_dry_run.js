...
test('Worker uses one persistent browser and can focus an existing window',()=>{
  ...
  assert(index.includes('app.js?v=20260910-v20.2-admin-shell-performance-5')&&serviceWorker.includes('app.js?v=20260910-v20.2-admin-shell-performance-5'),'PWA cache does not include the combined admin shell/performance build');
