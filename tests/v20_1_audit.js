...
check('32. Admin scoped loading and large-list performance', () => {
  ...
  assert(read('index.html').includes('20260907-v20.2-performance-1')&&read('sw.js').includes('gun-shop-dmo-v20-2-performance-1'),'PWA cache version ยังไม่ตรงกับ performance build');
});
