...
async function loadAdmin(force = true, scope = state.adminView || 'dashboard') {
  ...
  if(force)state.adminLoadedScopes=new Set();
...
function bind() {
  ...
  const fbConnectWorkerBtn=document.getElementById('fbConnectWorkerBtn');if(fbConnectWorkerBtn)fbConnectWorkerBtn.onclick=facebookPairViaLocalTab;
